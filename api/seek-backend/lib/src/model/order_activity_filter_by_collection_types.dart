...
class OrderActivityFilterByCollectionTypes extends EnumClass {
  ...
  static Serializer<OrderActivityFilterByCollectionTypes> get serializer =>
  ...
  static OrderActivityFilterByCollectionTypes valueOf(String name) =>
      _$valueOf(name);
}
...
abstract class OrderActivityFilterByCollectionTypesMixin = Object
    with _$OrderActivityFilterByCollectionTypesMixin;
