...
final BuiltSet<OrderDataLegacyDataTypeEnum>
    ...
    BuiltSet<OrderDataLegacyDataTypeEnum>(const <OrderDataLegacyDataTypeEnum>[
...
class _$OrderDataLegacy extends OrderDataLegacy {
  ...
  factory _$OrderDataLegacy([void Function(OrderDataLegacyBuilder)? updates]) =>
      (OrderDataLegacyBuilder()..update(updates))._build();
  ...
  @override
  OrderDataLegacyBuilder toBuilder() => OrderDataLegacyBuilder()..replace(this);
