...
/// * [logIndex]
@BuiltValue()
abstract class OrderActivityCancelBid
    implements Built<OrderActivityCancelBid, OrderActivityCancelBidBuilder> {
  ...
  factory OrderActivityCancelBid(
          [void updates(OrderActivityCancelBidBuilder b)]) =
      _$OrderActivityCancelBid;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OrderActivityCancelBidBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<OrderActivityCancelBid> get serializer =>
      _$OrderActivityCancelBidSerializer();
}

class _$OrderActivityCancelBidSerializer
    implements PrimitiveSerializer<OrderActivityCancelBid> {
  @override
  ...
  void _deserializeProperties(
    ...
    required OrderActivityCancelBidBuilder result,
      ...
      switch (key) {
        case r'@type':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(OrderActivityCancelBidAtTypeEnum),
          ) as OrderActivityCancelBidAtTypeEnum;
  ...
  @override
  OrderActivityCancelBid deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
...
class OrderActivityCancelBidAtTypeEnum extends EnumClass {
  ...
  static const OrderActivityCancelBidAtTypeEnum cancelBid =
      _$orderActivityCancelBidAtTypeEnum_cancelBid;

  static Serializer<OrderActivityCancelBidAtTypeEnum> get serializer =>
      _$orderActivityCancelBidAtTypeEnumSerializer;

  const OrderActivityCancelBidAtTypeEnum._(String name) : super(name);

  static BuiltSet<OrderActivityCancelBidAtTypeEnum> get values =>
      _$orderActivityCancelBidAtTypeEnumValues;
  static OrderActivityCancelBidAtTypeEnum valueOf(String name) =>
      _$orderActivityCancelBidAtTypeEnumValueOf(name);
}
