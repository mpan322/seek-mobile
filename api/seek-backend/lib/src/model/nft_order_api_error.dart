...
/// * [message]
@BuiltValue()
abstract class NftOrderApiError
    implements Built<NftOrderApiError, NftOrderApiErrorBuilder> {
  ...
  factory NftOrderApiError([void updates(NftOrderApiErrorBuilder b)]) =
      _$NftOrderApiError;
  ...
  static Serializer<NftOrderApiError> get serializer =>
      _$NftOrderApiErrorSerializer();
}

class _$NftOrderApiErrorSerializer
    implements PrimitiveSerializer<NftOrderApiError> {
  @override
  ...
  void _deserializeProperties(
    ...
    required NftOrderApiErrorBuilder result,
