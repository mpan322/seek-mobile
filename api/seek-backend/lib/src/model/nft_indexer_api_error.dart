...
/// * [message]
@BuiltValue()
abstract class NftIndexerApiError
    implements Built<NftIndexerApiError, NftIndexerApiErrorBuilder> {
  ...
  factory NftIndexerApiError([void updates(NftIndexerApiErrorBuilder b)]) =
      _$NftIndexerApiError;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NftIndexerApiErrorBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<NftIndexerApiError> get serializer =>
      _$NftIndexerApiErrorSerializer();
}

class _$NftIndexerApiErrorSerializer
    implements PrimitiveSerializer<NftIndexerApiError> {
  @override
  ...
  void _deserializeProperties(
    ...
    required NftIndexerApiErrorBuilder result,
  ...
  @override
  NftIndexerApiError deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
