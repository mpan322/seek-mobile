...
import 'package:seek_backend/src/model/currency_api_error.dart';
import 'package:seek_backend/src/model/currency_rate.dart';
...
class CurrencyControllerApi {
  ...
  Future<Response<CurrencyRate>> getCurrencyRate({
    ...
    final _queryParameters = <String, dynamic>{
      r'blockchain': encodeQueryParameter(
          _serializers, blockchain, const FullType(String)),
      r'address':
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CurrencyRate),
            ) as CurrencyRate;
