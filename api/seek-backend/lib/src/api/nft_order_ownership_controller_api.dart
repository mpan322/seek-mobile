...
import 'package:seek_backend/src/model/page_nft_order_ownership_item.dart';
...
class NftOrderOwnershipControllerApi {
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PageNftOrderOwnershipItem),
  ...
  Future<Response<NftOrderOwnership>> getNftOrderOwnershipById({
    ...
    final _path = r'/v0.1/nft-order/ownerships/{ownershipId}'.replaceAll(
        '{' r'ownershipId' '}',
        encodeQueryParameter(_serializers, ownershipId, const FullType(String))
            .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
