...
import 'package:seek_backend/src/model/order_bids_pagination.dart';
...
class OrderBidControllerApi {
  ...
  Future<Response<OrderBidsPagination>> getBidsByItem({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'status': encodeCollectionQueryParameter<OrderBidStatus>(
        _serializers,
        status,
      ...
      if (maker != null)
        r'maker':
            encodeQueryParameter(_serializers, maker, const FullType(String)),
      if (platform != null)
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(OrderBidsPagination),
