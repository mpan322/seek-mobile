...
import 'package:seek_backend/src/model/aggregation_data.dart';
...
class OrderAggregationControllerApi {
  ...
  Future<Response<BuiltList<AggregationData>>>
      aggregateNftPurchaseBuyCollection({
    ...
    final _queryParameters = <String, dynamic>{
      r'startDate':
          encodeQueryParameter(_serializers, startDate, const FullType(int)),
      r'endDate':
          encodeQueryParameter(_serializers, endDate, const FullType(int)),
      if (size != null)
        r'size': encodeQueryParameter(_serializers, size, const FullType(int)),
      if (source_ != null)
        r'source': encodeQueryParameter(
            _serializers, source_, const FullType(Platform)),
    };
