...
import 'package:seek_backend/src/model/nft_activities.dart';
import 'package:seek_backend/src/model/nft_activity_filter.dart';
...
class NftActivityControllerApi {
  ...
  Future<Response<NftActivities>> getNftActivities({
    ...
    try {
      ...
      _bodyData =
          _serializers.serialize(nftActivityFilter, specifiedType: _type);
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(NftActivities),
            ) as NftActivities;
    } catch (error, stackTrace) {
      throw DioException(
