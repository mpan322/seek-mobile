...
import 'package:seek_backend/src/model/nft_order_api_error.dart';
import 'package:seek_backend/src/model/nft_order_item.dart';
import 'package:seek_backend/src/model/page_nft_order_item.dart';
...
class NftOrderItemControllerApi {
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PageNftOrderItem),
            ) as PageNftOrderItem;
  ...
  Future<Response<NftOrderItem>> getNftOrderItemById({
    ...
    final _path = r'/v0.1/nft-order/items/{itemId}'.replaceAll(
        '{' r'itemId' '}',
  ...
  Future<Response<NftItemMeta>> getNftOrderItemMetaById({
    ...
    final _path = r'/v0.1/nft-order/items/{itemId}/meta'.replaceAll(
        '{' r'itemId' '}',
        encodeQueryParameter(_serializers, itemId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<LazyNft>> getNftOrderLazyItemById({
    ...
    final _path = r'/v0.1/nft-order/items/{itemId}/lazy'.replaceAll(
        '{' r'itemId' '}',
        encodeQueryParameter(_serializers, itemId, const FullType(String))
            .toString());
    final _options = Options(
