...
import 'package:seek_backend/src/model/activities.dart';
...
class NftOrderActivityControllerApi {
  ...
  Future<Response<Activities>> getNftOrderActivitiesByCollection({
    ...
    final _queryParameters = <String, dynamic>{
      r'type': encodeCollectionQueryParameter<ActivityFilterTypes>(
        _serializers,
        type,
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(Activities),
            ) as Activities;
  ...
  Future<Response<Activities>> getNftOrderActivitiesByItem({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'contract':
          encodeQueryParameter(_serializers, contract, const FullType(String)),
      r'tokenId':
  ...
  Future<Response<Activities>> getNftOrderActivitiesByUser({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      r'user': encodeCollectionQueryParameter<String>(
        _serializers,
        user,
        const FullType(BuiltList, [FullType(String)]),
        format: ListFormat.multi,
