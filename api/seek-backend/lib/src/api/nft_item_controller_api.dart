...
import 'package:seek_backend/src/model/lazy_nft.dart';
import 'package:seek_backend/src/model/nft_indexer_api_error.dart';
import 'package:seek_backend/src/model/nft_item.dart';
import 'package:seek_backend/src/model/nft_item_meta.dart';
import 'package:seek_backend/src/model/nft_items.dart';
...
class NftItemControllerApi {
  ...
  Future<Response<NftItems>> getNftAllItems({
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (showDeleted != null)
        r'showDeleted': encodeQueryParameter(
            _serializers, showDeleted, const FullType(bool)),
      if (lastUpdatedFrom != null)
        r'lastUpdatedFrom': encodeQueryParameter(
            _serializers, lastUpdatedFrom, const FullType(int)),
      if (lastUpdatedTo != null)
        r'lastUpdatedTo': encodeQueryParameter(
            _serializers, lastUpdatedTo, const FullType(int)),
      if (includeMeta != null)
        r'includeMeta': encodeQueryParameter(
            _serializers, includeMeta, const FullType(bool)),
    };
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(NftItems),
            ) as NftItems;
  ...
  Future<Response<NftItem>> getNftItemById({
    ...
    final _path = r'/v0.1/nft/items/{itemId}'.replaceAll(
        '{' r'itemId' '}',
  ...
  Future<Response<NftItemMeta>> getNftItemMetaById({
    ...
    final _path = r'/v0.1/nft/items/{itemId}/meta'.replaceAll(
        '{' r'itemId' '}',
        encodeQueryParameter(_serializers, itemId, const FullType(String))
            .toString());
    final _options = Options(
  ...
  Future<Response<NftItems>> getNftItemsByCollection({
    ...
    final _queryParameters = <String, dynamic>{
      r'collection': encodeQueryParameter(
          _serializers, collection, const FullType(String)),
      if (continuation != null)
        r'continuation': encodeQueryParameter(
            _serializers, continuation, const FullType(String)),
      if (size != null)
  ...
  Future<Response<NftItems>> getNftItemsByCreator({
    ...
    final _queryParameters = <String, dynamic>{
      r'creator':
          encodeQueryParameter(_serializers, creator, const FullType(String)),
      if (continuation != null)
        r'continuation': encodeQueryParameter(
            _serializers, continuation, const FullType(String)),
      if (size != null)
  ...
  Future<Response<NftItems>> getNftItemsByOwner({
    ...
    final _queryParameters = <String, dynamic>{
      r'owner':
          encodeQueryParameter(_serializers, owner, const FullType(String)),
      if (continuation != null)
        r'continuation': encodeQueryParameter(
            _serializers, continuation, const FullType(String)),
      if (size != null)
  ...
  Future<Response<LazyNft>> getNftLazyItemById({
    ...
    final _path = r'/v0.1/nft/items/{itemId}/lazy'.replaceAll(
        '{' r'itemId' '}',
        encodeQueryParameter(_serializers, itemId, const FullType(String))
            .toString());
    final _options = Options(
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(LazyNft),
            ) as LazyNft;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> resetNftItemMetaById({
    ...
    final _path = r'/v0.1/nft/items/{itemId}/resetMeta'.replaceAll(
        '{' r'itemId' '}',
        encodeQueryParameter(_serializers, itemId, const FullType(String))
            .toString());
    final _options = Options(
