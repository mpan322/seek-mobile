 ...
 */
import type { PlacesKeywordParameter } from './placesKeywordParameter';
import type { PlacesLocationRequiredParameter } from './placesLocationRequiredParameter';
import type { PlacesMaxpriceParameter } from './placesMaxpriceParameter';
import type { PlacesMinpriceParameter } from './placesMinpriceParameter';
import type { PlacesNameParameter } from './placesNameParameter';
import type { PlacesOpennowParameter } from './placesOpennowParameter';
import type { PlacesPagetokenParameter } from './placesPagetokenParameter';
import type { PlacesRankbyParameter } from './placesRankbyParameter';
import type { PlacesRadiusParameter } from './placesRadiusParameter';
import type { PlacesTypeParameter } from './placesTypeParameter';
 ...
 */
keyword?: PlacesKeywordParameter;
/**
 * The point around which to retrieve place information. This must be specified as `latitude,longitude`.

 */
location: PlacesLocationRequiredParameter;
/**
 ...
 */
maxprice?: PlacesMaxpriceParameter;
/**
 * Restricts results to only those places within the specified range. Valid values range between 0 (most affordable) to 4 (most expensive), inclusive. The exact amount indicated by a specific value will vary from region to region.

 */
minprice?: PlacesMinpriceParameter;
/**
 ...
 */
opennow?: PlacesOpennowParameter;
/**
 ...
 */
pagetoken?: PlacesPagetokenParameter;
/**
